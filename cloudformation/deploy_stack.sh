...
#
inject_state_machine='python3 cloudformation/inject_state_machine_cfn.py -s state_machine/state_machine.json -c cloudformation/stack.yaml -o cloudformation/stack.provisional.yaml'
...
#
package='aws cloudformation package --template-file cloudformation/stack.provisional.yaml --output-template-file cloudformation/stack.final.yaml --s3-bucket cloudformationdeploysource'
